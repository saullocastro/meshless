...
for edge in edges:
    ...
    plt.plot(xcoord, ycoord, 'xk', ms=5, mew=0.25, mfc='None')
...
print('DEBUG domain consistence check Aexpected:', a * b)
print('DEBUG domain consistence check Acovered: ', Atotal)
...
np.savetxt('k0.csv', k0, delimiter=',', fmt='%1.3f')
k0 = coo_matrix(k0)
...
print('DEBUG umax expected  ', a * exx)
print('DEBUG umax calculated', umax)

#plt.xlim(-0.5, 3.5)
#plt.ylim(-0.5, 3.5)
plt.savefig('plot_espim_2d_membrane_fext_along_x_only.png', bbox_inches='tight')
#plt.show()
